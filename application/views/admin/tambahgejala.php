              ...
              <form action="<?php echo base_url(). 'admin/tambah_aksi/'; ?>" method="post">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <b>Masukkan</b><br>
                    <b>Kode Gejala:</b>
                    <input type="text" class="form-control form-control" name="kode_g" placeholder="Kode Gejala">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <div class="form-group row">
                  <div class="col-sm-6">
                    <b>Nama Gejala:</b>
                    <input type="text" class="form-control form-control" name="nama_g" placeholder="Nama Gejala">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
